  ...
  APP.post("/login", async (req, res) => {
    ...
    if (Controller.controllerLogin(user_password, user_password_confirmed)) {
      try {
        ...
        const result = await BD.client.query(
          "INSERT INTO tb_login (user_name, birthday_date, email, user_password) VALUES ($1, $2, $3, $4)",
          [user_name, birthday_date, email, user_password]
        );
